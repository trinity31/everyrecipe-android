...
import com.davinciapps.fridgemaster.databinding.ActivityDetailBinding
import com.davinciapps.fridgemaster.presentation.viewmodel.DetailViewModel
...
class DetailActivity : AppCompatActivity() {
    ...
    private fun showIngredients() {
        if(::ingredientsFragment.isInitialized) {
            ...
            transaction.replace(com.davinciapps.fridgemaster.R.id.fragment_container, ingredientsFragment)
            transaction.commit()
        }
    }
    ...
    private fun showProcedures() {
        if(::proceduresFragment.isInitialized) {
            val transaction: FragmentTransaction = supportFragmentManager.beginTransaction()
            transaction.replace(com.davinciapps.fridgemaster.R.id.fragment_container, proceduresFragment)
            transaction.commit()
        }
    }
